	...
	<body class="is-preload">
		...
		<div id="wrapper" class="divided">
			...
			<section
				...
				id="first">
				<div class="content">
					<h2>El Salvador Historic Background</h2>
					<p>
					...
					<ul class="actions stacked">
						<li><a href="ReadMore.html" class="button">Read More</a></li>
					</ul>
				</div>
				<div class="image">
			...
			<section
				...
				<div class="content">
					...
					<p>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id ante sed ex pharetra lacinia
						sit amet vel massa. Donec facilisis laoreet nulla eu bibendum. Donec ut ex risus. Fusce lorem
						lectus, pharetra pretium massa et, hendrerit vestibulum odio lorem ipsum dolor sit amet.
					</p>
					<ul class="actions stacked">
			...
			<section class="wrapper style1 align-center">
				<div class="inner">
					...
					<p>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id ante sed ex pharetra lacinia
						sit amet vel massa. Donec facilisis laoreet nulla eu bibendum. Donec ut ex risus. Fusce lorem
						lectus, pharetra pretium massa et, hendrerit vestibulum odio lorem ipsum.
					</p>
				</div>
				...
				<div class="inner">
					...
					<div class="items style1 medium onscroll-fade-in">
						<section>
							...
							<h3>Lorem</h3>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi dui turpis, cursus eget
								orci amet aliquam congue semper. Etiam eget ultrices risus nec tempor elit.
							</p>
						</section>
						<section>
